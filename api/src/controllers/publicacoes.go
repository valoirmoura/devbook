...
// BuscarPublicacao traz uma publicacao especifica de um usuario
...
// AtualizarPublicacao atualiza uma publicacao especifica
...
// DeletarPublicacao remove uma publicacao de um usuario
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID == usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel excluir uma publicacao que nao seja de sua autoria"))
		return
	}
...
// BuscarPublicacoesPorUsuario traz todas as publicaoes de um usuario
...
// DescurtirPublicacao Descurti uma Publicacao
